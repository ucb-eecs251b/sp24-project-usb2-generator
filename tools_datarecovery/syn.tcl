...
puts "set_dont_touch hinst:data_recovery/sampler"
set_dont_touch hinst:data_recovery/sampler
...
puts "write_hdl > /scratch/eecs251b-aaz/sp24-project-usb2-generator/build/syn-rundir/data_recovery.mapped.v" 
write_hdl > /scratch/eecs251b-aaz/sp24-project-usb2-generator/build/syn-rundir/data_recovery.mapped.v
puts "write_script > data_recovery.mapped.scr" 
write_script > data_recovery.mapped.scr
puts "write_sdc -view ss_100C_1v60.setup_view > /scratch/eecs251b-aaz/sp24-project-usb2-generator/build/syn-rundir/data_recovery.mapped.sdc" 
write_sdc -view ss_100C_1v60.setup_view > /scratch/eecs251b-aaz/sp24-project-usb2-generator/build/syn-rundir/data_recovery.mapped.sdc
puts "write_sdf > /scratch/eecs251b-aaz/sp24-project-usb2-generator/build/syn-rundir/data_recovery.mapped.sdf" 
write_sdf > /scratch/eecs251b-aaz/sp24-project-usb2-generator/build/syn-rundir/data_recovery.mapped.sdf
puts "write_design -innovus -hierarchical -gzip_files data_recovery" 
write_design -innovus -hierarchical -gzip_files data_recovery
puts "quit" 
quit