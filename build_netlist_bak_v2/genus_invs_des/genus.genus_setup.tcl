...
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:data_recovery]]" != "{{mode:data_recovery/ss_100C_1v60.setup_view inf}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:data_recovery/ss_100C_1v60.setup_view inf}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:data_recovery]]"
}
# tns
...
if {$_cell_area_ != "15701"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 15701,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "4900"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 4900,  current net area: $_net_area_"
}
unset _net_area_
