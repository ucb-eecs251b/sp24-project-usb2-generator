...
# Generated on: Mon Apr 15 14:40:10 PDT 2024 (Mon Apr 15 21:40:10 UTC 2024)
...
set_log_file fv/Sampler/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/Sampler -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/share/instsww/cadence/GENUS/tools.lnx86"
set CDN_SYNTH_ROOT      "/share/instsww/cadence/GENUS/tools.lnx86"
set env(CW_DIR) "/share/instsww/cadence/GENUS/tools.lnx86/lib/chipware"
set CW_DIR      "/share/instsww/cadence/GENUS/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path . /share/instsww/cadence/GENUS/tools.lnx86/lib/tech -library -both
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09  /scratch/eecs251b-aaz/sp24-project-usb2-generator/src/sampler.v
elaborate_design -golden -root {Sampler} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/Sampler/fv_map.v.gz
elaborate_design -revised -root {Sampler}

read_power_intent -golden /scratch/eecs251b-aaz/sp24-project-usb2-generator/build/syn-rundir/power_spec.cpf
commit_power_intent -golden -insert_isolation

read_power_intent -revised fv/Sampler/fv_map.cpf
...
#add_name_alias fv/Sampler/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/Sampler/rtl_to_fv_map.log
}
